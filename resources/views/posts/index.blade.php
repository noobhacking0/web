  ...
  border-radius: 0.375rem !important;
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">NGE'<span style="color:green">FOOD</span></a>
            <!-- Sidebar Toggle-->
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <a href="{{ route('posts.create') }}" class="btn btn-sm btn-success mb-1">TAMBAH POST</a>
                            </div>
                            <div class="card-body">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; aryaendsha 2023</div>
                            <div>
